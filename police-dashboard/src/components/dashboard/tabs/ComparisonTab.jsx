                ...
                <div className={`w-full ${isPrint ? 'h-[600px] md:h-[650px]' : 'h-[600px] md:h-[850px]'}`}>
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={data} margin={{ top: 40, right: 20, left: 20, bottom: 20 }}>
                            ...
                            <Bar dataKey="month2" name={monthNames[1]} fill="#004aad" radius={[8, 8, 0, 0]} barSize={40} label={{ position: 'top', fill: '#1e3a8a', fontSize: 16, fontWeight: 'bold', formatter: (val) => val.toLocaleString() }} />
                        </BarChart>
                    </ResponsiveContainer>
                </div>
