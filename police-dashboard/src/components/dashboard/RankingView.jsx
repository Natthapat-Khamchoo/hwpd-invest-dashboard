        ...
        >
            ...
            <div className="p-6 relative z-10">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h3 className={`text-lg font-bold ${isPremium ? 'text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-yellow-500' : 'text-white'}`}>
                            {title}
                        </h3>
        ...
        <div className="relative min-h-screen -m-4 sm:-m-6 p-4 sm:p-6 overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 space-y-8 animate-in fade-in slide-in-from-bottom-5 duration-700 flex-1 flex flex-col">
                ...
                <div className={`text-center space-y-2 py-4 transition-all duration-500 ${selectedCategory ? 'blur-sm opacity-50' : ''}`}>
                    ...
                    <h2 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white via-yellow-100 to-yellow-500 drop-shadow-sm tracking-tight uppercase">
                        HWPD Hall of Fame
                    </h2>
