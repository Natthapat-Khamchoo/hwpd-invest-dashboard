...
export const MonthlyBarChart = ({ data, year, onYearChange }) => (
  <div className="mt-6 bg-slate-800/40 backdrop-blur-xl p-4 sm:p-6 rounded-xl shadow-lg border border-white/10 hover:border-white/20 transition-all duration-300">
